...
data_graph_marker_size = 6.0                        # (float)
data_graph_marker_edge_color = '#000000'            # Hex color (str)
data_graph_marker_edge_width = 0.5                  # (float)
...
comparison_graph_data_lide_width = 1.0              # (float)
...
comparison_graph_data_marker_size = 6.0             # (float)
comparison_graph_data_marker_edge_color = '#361156' # Hex color (str)
comparison_graph_data_marker_edge_width = 0.5       # (float)
...
comparison_graph_equation_line_width = 1.0          # (float)
